...
# NOTE: This code doesn't work anymore since output is now cmdstan and most functions still assume rstan.
...
path_pdf = 'ANALYSIS/RESULTS/luscinia/cc/results.pdf'
path_pdf_pca = 'ANALYSIS/RESULTS/luscinia/cc/results_city_pca.pdf'
path_models = 'ANALYSIS/RESULTS/luscinia/cc/models'
path_log = 'ANALYSIS/RESULTS/luscinia/cc/pdf_log.txt'
...
for(file in files){
  name = file %>% 
    str_remove('ANALYSIS/RESULTS/luscinia/cc/models/') %>% 
