...
To test the effect of distance between parks we ran a Bayesian model similar to the model in the main text, but within each city. We used a multi-normal distribution where the variance-covariance was computed from the distance matrix using the L2-norm.
...
```{r, fig.cap="Covariance between parks in Athens as function of normalised distance.", echo=FALSE}
knitr::include_graphics('../../RESULTS/figures/distance/distance result - Athens.pdf')
```

```{r, fig.cap="Covariance between parks in Madrid as function of normalised distance..", echo=FALSE}
knitr::include_graphics('../../RESULTS/figures/distance/distance result - Madrid.pdf')
```

```{r, fig.cap="Covariance between parks in Barcelona as function of normalised distance.", echo=FALSE}
knitr::include_graphics('../../RESULTS/figures/distance/distance result - Barcelona.pdf')
```

```{r, fig.cap="Map of all parks sampled in Athens.", echo=FALSE}
knitr::include_graphics('../../RESULTS/maps/parks_map_athens.pdf')
```

```{r, fig.cap="Map of all parks sampled in Barcelona", echo=FALSE}
knitr::include_graphics('../../RESULTS/maps/parks_map_barcelona.pdf')
```

```{r, fig.cap="Map of all parks sampled in Brussels", echo=FALSE}
knitr::include_graphics('../../RESULTS/maps/parks_map_brussels.pdf')
```

```{r, fig.cap="Map of all parks sampled in Italy", echo=FALSE}
knitr::include_graphics('../../RESULTS/maps/parks_map_italy.pdf')
```

```{r, fig.cap="Map of all parks sampled in Madrid", echo=FALSE}
knitr::include_graphics('../../RESULTS/maps/parks_map_madrid.pdf')
```
